...
This repository contains the conceptual definition and theoretical framework for **VEGA Technical Continuum**, 
...
├── LICENSE             # CC BY 4.0
├── paper/
│   └── vega-technical-continuum.tex    # LaTeX dissertation
├── whitepaper/
│   └── vega-technical-continuum.md     # White paper
└── translations/
    ├── de/             # German
    ├── en/             # English
    ├── tr/             # Turkish
...
```bibtex
@misc{vega2025vegatechnicalcontinuum,
  author = {Vega, Adam Eren},
  title = {VEGA Technical Continuum: A Conceptual Framework},
  year = {2025},
  publisher = {GitHub},
  url = {https://github.com/vegafoundation/vega-technical-continuum}
}
```
